...
export default function TeacherSearchPage() {
  ...
  const [results, setResults] = useState<{courses: any[], assignments: any[], students: any[]}>({ courses: [], assignments: [], students: [] });
  ...
  useEffect(() => {
    if (query) {
      ...
      setResults({ courses: [], assignments: [], students: [] });
      setLoading(false);
    }
  }, [query]);
    ...
    <div style={{ padding: "32px", maxWidth: "1200px", margin: "0 auto", display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      {loading ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          {results.courses.length === 0 && results.assignments.length === 0 && (
