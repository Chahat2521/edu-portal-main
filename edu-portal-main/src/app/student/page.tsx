  ...
  return (
    <div style={{ display: "flex", gap: 12, alignItems: "flex-start", padding: "12px 0", borderBottom: "1px solid var(--border)" }}>
      ...
      <div>
        ...
        <div style={{ fontSize: 12, color: "var(--muted)", display: "flex", alignItems: "center", gap: 4 }}><span>📍</span>{location}</div>
      </div>
    </div>
  );
}
...
export default function StudentDashboard() {
  ...
  const stats = [
    { icon: "🎓", label: "Current GPA",      value: "3.92", sub: "▲ +0.05",   color: "#1e3a5f" },
    { icon: "🏆", label: "Credits Earned",    value: "84",   sub: "of 120",    color: "#7dc443" },
    { icon: "📋", label: "Upcoming Tasks",    value: "5",    sub: "3 this week", color: "#f59e0b" },
    { icon: "💳", label: "Term Balance",      value: "$0.00", sub: "Cleared",   color: "#22c55e" },
  ];
  ...
  const quickLinks = [
    ...
    { href: "/student/groups",      icon: "👥", label: "Study Groups" },
  ];
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 24 }}>
        ...
        <div>
          ...
          <div style={{ marginTop: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                { icon: "✅", text: "ER Diagram Lab Report submitted",        time: "2 hrs ago",  color: "#22c55e" },
                { icon: "📊", text: "Grade posted for MATH 210 Quiz 3",       time: "5 hrs ago",  color: "#4fa3e0" },
                { icon: "📢", text: "New resource uploaded: SQL Practice Set", time: "Yesterday", color: "#f59e0b" },
                { icon: "👥", text: "You joined Study Group: CS301 Trees",    time: "2 days ago", color: "#8b5cf6" },
              ].map((item) => (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 16, padding: 22, boxShadow: "var(--shadow-sm)" }}>
            ...
            <Link href="/student/groups" style={{ display: "block", textAlign: "center", marginTop: 14, background: "#1e3a5f", color: "#fff", borderRadius: 10, padding: "9px 0", fontSize: 13, fontWeight: 700, textDecoration: "none" }}>
              👥 View All Groups
            </Link>
          </div>
          ...
          {/* Announcements */}
          <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 16, padding: 22, boxShadow: "var(--shadow-sm)" }}>
            <h3 style={{ fontSize: 16, fontWeight: 800, color: "var(--text)", margin: "0 0 14px" }}>📢 Announcements</h3>
            {[
